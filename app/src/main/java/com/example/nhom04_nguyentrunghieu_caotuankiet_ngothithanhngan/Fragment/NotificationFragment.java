...
import com.example.nhom04_nguyentrunghieu_caotuankiet_ngothithanhngan.Adapter.NotificationAdapter;
...
//        listData.add(new Notification(R.drawable.anh3x4, "Trung hieu", "đã thích bài viết của bạn", "1 giấy"));
//        listData.add(new Notification(R.drawable.anh3x4, "Trung hieu", "đã thích bài viết của bạn", "1 giấy"));
//        listData.add(new Notification(R.drawable.anh3x4, "Trung hieu", "đã thích bài viết của bạn", "1 giấy"));
//        listData.add(new Notification(R.drawable.anh3x4, "Trung hieu", "đã thích bài viết của bạn", "1 giấy"));
//        listData.add(new Notification(R.drawable.anh3x4, "Trung hieu", "đã thích bài viết của bạn", "1 giấy"));
